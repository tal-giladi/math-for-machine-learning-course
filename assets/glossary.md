...
Keep this open while you read the lessons. Pair it with the [Math cheat sheet](math-cheatsheet.md) for the formulas and the [PyTorch cheat sheet](pytorch-cheatsheet.md) for the code each term maps to.
