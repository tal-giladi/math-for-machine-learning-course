...
Use this next to the [Math cheat sheet](math-cheatsheet.md): read a formula there, then find the row here that turns it into code. Any unfamiliar term is in the [Glossary](glossary.md).
